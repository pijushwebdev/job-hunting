...
const ShowAppliedJob = ({ job }) => {
    ...
    return (
        <div className='flex justify-between shadow-md rounded-md items-center mb-5 p-5'>
            <div className='flex'>
                <div className='applied-img rounded-md mr-5 w-60 h-60 p-10 flex items-center justify-center'>
                    <img className='w-full m-5' src={company_logo} alt="" />
                </div>
                <div>
